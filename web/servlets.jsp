...
<body>
<h1>Front End: Servlets</h1><br>
<button id="clear-table">Clear Tables</button>
<button onclick="window.location.href='/'">REST Front End</button>
<br>
<br>
<fieldset>
    <legend>Show All Films</legend>
    <button id="show-data-json-servlet" name="json">Get All Films - JSON</button>
    <button id="show-data-xml-servlet" name="xml">Get All Films - XML</button>
    <button id="show-data-text-servlet" name="plaintext">Get All Films - Text</button>
    <br>
    <br>
    <div id="table"></div>
</fieldset>
...
<fieldset>
    <form id="search-form">
        ...
        <br>
        <input type="button" name="json" value="Search - JSON" id="show-search-json-servlet"/>
        <input type="button" name="xml" value="Search - XML" id="show-search-xml-servlet"/>
        <input type="button" name="plaintext" value="Search - Text" id="show-search-text-servlet"/>
        <br>
        <br>
...
<fieldset>
    ...
    <form id="insert-form">
        ...
        <br/>
        <br>
        <input type="button" value="Insert Film" id="show-insert-servlet"/>
    </form>
</fieldset>
<br>
<fieldset>
    ...
    <form id="update-form">
        ...
        <br/><br>
        <input type="button" value="Update Film" id="show-update-servlet"/>
    </form>
</fieldset>
<br>
<fieldset>
    ...
    <form id="delete-form">
        ...
        <label>ID: </label><input type="number" name="id"/><br/>
        <br>
        <input type="button" value="Delete Film" id="show-delete-servlet"/>
    </form>
</fieldset>
</body>
</html>
